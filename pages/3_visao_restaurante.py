...
def avg_time_delivery(df1, festival, op ):
    """
...
with st.container():
    ...
    with col3:
        df_aux = avg_time_delivery(df1,'Yes', 'avg_time' )
        col3.metric( 'Tempo Médio', df_aux )

    with col4:
        df_aux = avg_time_delivery(df1, 'Yes', 'std_time' )
        col4.metric( 'STD Entrega', df_aux )

    with col5:
        df_aux = avg_time_delivery(df1, 'No', 'avg_time' )
        col5.metric( 'Tempo Médio', df_aux )

    with col6:
        df_aux = avg_time_delivery(df1, 'No', 'std_time' )
